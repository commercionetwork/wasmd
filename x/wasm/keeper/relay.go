...
func (k Keeper) OnOpenChannel(
	...
	gas = 1000000 // TODO: remove this line once we have a better gas estimation
	...
	gasMeter := sdk.NewGasMeter(1100000)
	res, gasUsed, execErr := k.wasmVM.IBCChannelOpen(codeInfo.CodeHash, env, msg, prefixStore, cosmwasmAPI, querier, gasMeter, gas, costJSONDeserialization)
